...
TennisGame3.prototype.getScore = function() {
  ...
  if ((this.scoreOfPlayer1 < 4 && this.scoreOfPlayer2 < 4) && (this.scoreOfPlayer1 + this.scoreOfPlayer2 < 6)) {
      let result = ["Love", "Fifteen", "Thirty", "Forty"];
      score = result[this.scoreOfPlayer1];
      return (this.scoreOfPlayer1 === this.scoreOfPlayer2) ? score + "-All" : score + "-" + result[this.scoreOfPlayer2];
  } else {
